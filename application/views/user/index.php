            ...
            <div class="col-lg-12 mb-3">
                <div class="d-flex align-items-center justify-content-between welcome-content">
                    <div class="navbar-breadcrumb">
                        <h4 class="mb-1">Welcome to Livia Mailer</h4>
                    </div>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
							<div class="row justify-content-center">
								<div class="col-4 d-flex justify-content-center border border-success">
									<a href="<?php echo base_url()?>subscribers" class="tb_box_cat_home">

										<img src="<?php echo base_url('images/icon/add-user.svg')?>" width="110" height="110" class="rounded mx-auto d-block" alt="">
