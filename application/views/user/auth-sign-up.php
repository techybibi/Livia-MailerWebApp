								...
								<div class="row">
									<div class="col-lg-12">
										<div class="floating-label form-group">
											<input class="floating-input form-control border border-primary" type="text" name="fname" value="<?php echo set_value('fname');?>">
											<label>Full Name</label>
										</div>
									</div>
									<div class="col-lg-12">
										<div class="floating-label form-group">
											<input class="floating-input form-control border border-primary" type="email" name="email" value="<?php echo set_value('email');?>">
											<label>Email</label>
										</div>
									</div>
									<div class="col-lg-12">
