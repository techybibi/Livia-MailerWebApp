...
<div class="wrapper">
	...
	<!-- Fixed Side Menu End -->        <div class="iq-top-navbar p-3">
					...
					<nav class="iq-sidebar-menu">
						<div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
							<a href="index.html" class="header-logo">
								<img src="<?php echo base_url().'images/logo.png'?>" class="img-fluid rounded-normal" alt="logo1">
							</a>
								...
								<ul id="ui" class="iq-submenu sub-scrll collapse" data-parent="#iq-sidebar-toggle">
									...
									<li class=" ">
										<a href="<?php echo base_url()?>email">
											...
											</svg> <span>View Campain</span>
										</a>
									</li>
								</ul>
							</li>
							<li class=" ">
								<a href="<?php echo base_url()?>settings" aria-expanded="false">
					...
					<button class="navbar-toggler" type="button" data-toggle="collapse"
						...
						<i class="ri-menu-3-line"></i>
							...
							<div class="caption-content pr-5">
								<a href="<?php echo base_url()?>login/profile/<?php echo $this->session->userdata('uid')?>"><button class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
											<path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
											<path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
										</svg> My Account</button></a>
								<a href="<?php echo base_url()?>login/logout"><button class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
